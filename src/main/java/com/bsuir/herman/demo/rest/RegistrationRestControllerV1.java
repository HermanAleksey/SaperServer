//package com.bsuir.herman.demo.rest;
//
//import com.bsuir.herman.demo.dto.AuthenticationRequestDto;
...
//
//    @Autowired
//    public RegistrationRestControllerV1(AuthenticationManager authenticationManager, JwtTokenProvider jwtTokenProvider, UserService userService) {
...
//
//            String username = requestDto.getUsername(); //авторизовать пользователя
